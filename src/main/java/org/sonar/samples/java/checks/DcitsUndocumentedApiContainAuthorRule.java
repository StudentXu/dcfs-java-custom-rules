...
@Rule(key = "DcitsUndocumentedApiContainAuthor")
public class DcitsUndocumentedApiContainAuthorRule extends BaseTreeVisitor implements JavaFileScanner {
  ...
  private  boolean isOverridingMethod(Tree tree) {
